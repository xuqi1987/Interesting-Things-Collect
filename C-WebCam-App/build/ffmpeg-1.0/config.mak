...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --enable-shared --enable-pthreads
prefix=/usr/local
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
